<%@ Page Title="" Language="C#" MasterPageFile="~/App_Pages/Secure/SiteAuth.master" AutoEventWireup="true"
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <asp:Panel ID="pnl1" runat="server" DefaultButton="btnSave">
        ...
        <br />
        <div class="btnRibbon">
            <asp:Button ID="btnBack" runat="server" CssClass="btn btn-primary" OnClick="btnBack_Click" Text="Go Back" />
            <asp:Button ID="btnSave" runat="server" CssClass="btn btn-primary" OnClick="btnSave_Click" Text="Save" />
            <asp:Button ID="btnDelete" runat="server" CssClass="btn btn-primary" OnClick="btnDelete_Click" OnClientClick="return GetConfirmation();" Text="Delete" />
        </div>
    </asp:Panel>
</asp:Content>
