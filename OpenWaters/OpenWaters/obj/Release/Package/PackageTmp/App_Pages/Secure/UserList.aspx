<%@ Page Title="" Language="C#" MasterPageFile="SiteAuth.Master" AutoEventWireup="true" CodeBehind="UserList.aspx.cs" Inherits="OpenEnvironment.UserList" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
   <div class="contentArea">
    ...
    <asp:GridView ID="grdUsers" runat="server" 
   	...
   	<div class="btnRibbon">
           <asp:Button ID="btnAdd" runat="server" CssClass="btn btn-primary" Text="Add New" OnClick="btnAdd_Click1" />
    </div>
    </div>
</asp:Content>
