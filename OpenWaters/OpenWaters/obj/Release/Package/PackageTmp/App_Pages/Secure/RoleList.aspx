<%@ Page Title="" Language="C#" MasterPageFile="SiteAuth.Master" AutoEventWireup="true" CodeBehind="RoleList.aspx.cs" Inherits="OpenEnvironment.RoleList" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <br />
   	<div class="btnRibbon">
        <asp:Button ID="btnAdd" runat="server" CssClass="btn btn-primary" Text="Add New" onclick="btnAdd_Click" Visible="false" />
    </div>
    </div>
