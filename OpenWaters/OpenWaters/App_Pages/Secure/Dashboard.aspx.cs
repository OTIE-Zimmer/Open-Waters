    ...
    public partial class Dashboard : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                ...
                {
                    Trace.Warn("ORG=" + Session["OrgID"].ToString());
                    lblOrgName.Text = db_WQX.GetWQX_ORGANIZATION_ByID(Session["OrgID"].ToString()).ORG_FORMAL_NAME;
                    lblMonLocs.Text = db_WQX.GetWQX_MONLOC(true, Session["OrgID"].ToString(), false).Count.ToString();
        ...
        {
            Response.Redirect("~/App_Pages/Secure/WQXUploadExcel.aspx");
        }
