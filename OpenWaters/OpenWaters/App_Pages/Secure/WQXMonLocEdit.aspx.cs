    ...
    public partial class WQXMonLocEdit : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                ...
                Utils.BindList(ddlState, dsRefData, "VALUE", "TEXT");
        ...
        {
            ddlCounty.DataSource = db_Ref.GetT_WQX_REF_COUNTY_By_State(ddlState.SelectedValue.ToString());
            ddlCounty.DataTextField = "COUNTY_NAME";
            ddlCounty.DataValueField = "COUNTY_CODE";
            ddlCounty.DataBind();
            Trace.Warn("Update ddlCounty.  State=" + ddlState.SelectedValue.ToString());
        }
    }
}