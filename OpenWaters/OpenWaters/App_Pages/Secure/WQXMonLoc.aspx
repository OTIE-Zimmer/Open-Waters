<%@ Page Title="Tribal-FERST Mvskoke Open Waters Module - Monitoring Locations" Language="C#" MasterPageFile="SiteAuth.Master" AutoEventWireup="true"
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <asp:UpdatePanel runat="server" ID="TimedPanel" UpdateMode="Conditional">
        ...
        <ContentTemplate>
            ...
            <br />
            <asp:GridView ID="grdMonLoc" runat="server" 
                GridLines="None" CssClass="table table-striped table-bordered"
                PageSize="6"
                AllowPaging="True" OnPageIndexChanging="grdMonLoc_PageIndexChanging"
