<%@ Page Title="Tribal-FERST Mvskoke Open Waters Module - Activity Details" Language="C#" MasterPageFile="SiteAuth.Master" AutoEventWireup="true" CodeBehind="WQXActivityEdit.aspx.cs" Inherits="OpenEnvironment.WQXActivityEdit" %>
    ...
    <div class="panel-body" >
        <div class="row">
            ...
            <div style="width:380px; float:left"> 
                ...
                CssClass="failureNotification"></asp:RequiredFieldValidator>
                <!--<span class="fldLbl">Time Zone:</span> -->
            ...
            <div class="tab" style="clear: both;">
                <div id="tab-1" class="tab-content">
                    ...
                    <div class="row">
                        ...
                        <div style="width:380px; float:left" hidden="hidden"> 
        ...
        <br />
        <div class="btnRibbon">
            <asp:Button ID="btnSave" runat="server" CssClass="btn btn-primary" Text="Save" onclick="btnSave_Click" Style="float:left;" />
            <asp:Button ID="btnCancel" runat="server" CssClass="btn btn-primary" Text="Exit" onclick="btnCancel_Click" CausesValidation="false" Style="float:left;" />
        ...
        <ContentTemplate>
            ...
            <asp:GridView ID="grdResults" runat="server" GridLines="None" CssClass="grd" PagerStyle-CssClass="pgr" AutoGenerateColumns="False" AlternatingRowStyle-CssClass="alt" 
                ...
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="Value Type" SortExpression="RESULT_VALUE_TYPE" Visible="false">
                        <EditItemTemplate>
                    ...
                    <asp:TemplateField HeaderText="Status" SortExpression="RESULT_STATUS" Visible="false">
                        <EditItemTemplate>
