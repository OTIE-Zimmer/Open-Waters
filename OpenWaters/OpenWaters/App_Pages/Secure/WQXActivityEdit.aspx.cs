    ...
    public partial class WQXActivityEdit : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                ...
                {
                    txtActivityID.Text = "New" + DateTime.Now.ToString("yyyyMMddHHmmss");
        ...
        protected void grdResults_RowUpdating(object sender, GridViewUpdateEventArgs e)
        {
            ...
            db_WQX.InsertOrUpdateT_WQX_RESULT(grdResults.DataKeys[e.RowIndex].Values[0].ConvertOrDefault<int>(), ActID, null, ddlChar.SelectedValue,
                ...
                "Final", null, txtComment.Text, null, null, ddlTaxa.SelectedValue, null, 
        ...
        protected void grdResults_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            if (e.CommandName.Equals("AddNew"))
            {
                ...
                db_WQX.InsertOrUpdateT_WQX_RESULT(null, ActID, null, ddlNewChar.SelectedValue, ddlNewSampFraction.SelectedValue,
                    txtNewResultVal.Text, ddlNewUnit.SelectedValue, "Final", null, txtNewComment.Text,  
        ...
        protected void grdResults_RowDataBound(object sender, GridViewRowEventArgs e)
        {
                ...
                ((e.Row.RowState & DataControlRowState.Edit) == DataControlRowState.Edit))
            {
                ...
                //value type
                //These values are not in the Database Table.
        ...
        private void PopulateDropDown (DropDownList ddl, ObjectDataSource ds, string selVal, string listVal, string listName)
        {
            if (ddl != null)
            {
                ...
                Trace.Warn("Drop down list " + ddl.ID.ToString() + " has " + ddl.Items.Count.ToString());
            }
            else
            {
                Trace.Warn("Drop down list " + ddl.ID.ToString() + " is null");
            }
        }
