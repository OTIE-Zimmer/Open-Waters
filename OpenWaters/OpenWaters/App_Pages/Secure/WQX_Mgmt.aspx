<%@ Page Title="" Language="C#" MasterPageFile="SiteAuth.Master" AutoEventWireup="true" CodeBehind="WQX_Mgmt.aspx.cs" Inherits="OpenEnvironment.WQX_Mgmt" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <asp:Panel ID="pnlFilter" CssClass="fltBox" runat="server" DefaultButton="btnSubmit">
        <div class="fltTitle">Submission Options (submission can take several minutes)</div>
        <div class="fltMain">
            <div class="row">
            ...
            <asp:Button ID="btnSubmit" runat="server" CssClass="btn btn-primary" onclick="btnSubmit_Click" Text="Submit All Pending Records to EPA" />
            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            <asp:Button ID="btnReset" runat="server" CssClass="btn btn-primary" Text="Reset Service" onclick="btnReset_Click" onmouseout="BalloonPopupControlBehavior.hidePopup();" />
