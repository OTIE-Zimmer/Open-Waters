...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div style="padding:10px">
        ...
        <div class="clear"></div>
        <div class="btnRibbon">
            <asp:Button ID="btnAdd" runat="server" CssClass="btn btn-primary" Text="Add New" Visible="false"   />
        </div>
    </div>
    <!-- ******************** MODAL PANEL -->
    <asp:Panel ID="pnlModal" Width="500px" runat="server" CssClass="modalWindow" Style="display: none;" DefaultButton="btnNewSave">
        <div style="padding: 6px; background-color: #FFF; border: 1px solid #98B9DB;">
            ...
            <div class="row" ></div>
            <div class="btnRibbon">
                <asp:Button ID="btnNewSave" runat="server" Text="Save" CssClass="btn btn-primary" OnClick="btnNewSave_Click" />
    ...
    <div class="btnRibbon">
        <asp:Button ID="btnGetRefData" runat="server" CssClass="btn btn-primary" OnClick="btnGetRefData_Click"
