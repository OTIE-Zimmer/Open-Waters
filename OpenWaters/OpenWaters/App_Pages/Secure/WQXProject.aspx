...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="contentArea" >
        ...
        <div class="page-toolbar">                  
            <div class="page-toolbar-block">                   
                    <div class="page-toolbar-title">Projects</div>              
            </div>               
       </div>   
    ...
    <asp:UpdatePanel runat="server" ID="TimedPanel" UpdateMode="Conditional">
        ...
        <ContentTemplate>
            ...
            <asp:GridView ID="grdProject" runat="server" 
                GridLines="None" CssClass="table table-striped table-bordered" PagerStyle-CssClass="pgr"
                AutoGenerateColumns="False" AllowPaging="True" AlternatingRowStyle-CssClass="alt" 
                onrowcommand="grdProject_RowCommand" PageSize="6"
