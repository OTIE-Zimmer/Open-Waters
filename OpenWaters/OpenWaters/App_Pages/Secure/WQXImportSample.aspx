...
<style>
    ...
    <div class="btnRibbon">
        <asp:Button ID="btnCancel" runat="server" CssClass="btn btn-primary" Text="Cancel Import" OnClick="btnCancel_Click"  />
        <asp:Button ID="btnSample" runat="server" CssClass="btn btn-primary" Text="View Imported Samples" Visible="false" OnClick="btnSample_Click"  />
    </div>
</asp:Content>
