<%@ Page Title="" Language="C#" MasterPageFile="~/App_Pages/Secure/SiteAuth.master" AutoEventWireup="true" CodeBehind="RoleEdit.aspx.cs" Inherits="OpenEnvironment.RoleEdit" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <asp:Panel ID="pnl1" runat="server" DefaultButton="btnSave">
        ...
        <div class="row">
            <table>
                <tr>
                    ...
                    <td>
                        <asp:Button ID="btnAdd" CssClass="btn btn-primary" Width="180px" runat="server" Text="Add User to Role &gt;&gt;" OnClick="btnAdd_Click" /><br />
                        <asp:Button ID="btnRemove" CssClass="btn btn-primary" Width="180px" runat="server" Text="&lt;&lt; Remove User From Role" OnClick="btnRemove_Click" />
                    </td>
                    <td>
                        Users in Role<br />
        ...
        <div class="btnRibbon">
            ...
            <asp:Button ID="btnDelete" runat="server" CssClass="btn btn-primary" OnClientClick="return GetConfirmation();" Text="Delete" OnClick="btnDelete_Click" />
        </div>
    </asp:Panel>
</asp:Content>
